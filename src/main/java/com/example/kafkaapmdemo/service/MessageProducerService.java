...
public class MessageProducerService {
    ...
    public void sendMessage(String topic, String key, String message) {
        ...
        try {
            ...
            // Přidej business headers pro vyhledávání
            ...
            // APM automaticky přidá distributed tracing headers
            kafkaSpan.injectTraceHeaders((name, value) -> {
                headers.add("apm-" + name, value.getBytes(StandardCharsets.UTF_8));
            });
            
            // Přidej labels pro vyhledávání v Kibana - DŮLEŽITÉ pro search
            ...
            kafkaSpan.addLabel("transparent", transparent);
            kafkaSpan.addLabel("business.operation", "kafka-send");
            kafkaSpan.addLabel("source.service", "kafka-producer-java");
            
            // Přidej stejné labels i do parent transaction pro lepší vyhledávání
